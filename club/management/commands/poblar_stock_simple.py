...
from stock_ventas.models import Producto, CategoriaProducto, Proveedor, Caja, Venta
...
class Command(BaseCommand):
    help = 'Poblar datos simples para stock y ventas'
    ...
    def handle(self, *args, **options):
        ...
        # Crear solo ventas simples (sin detalles para evitar problemas de stock)
        for i in range(15):
            ...
            for _ in range(num_ventas):
                total_venta = random.randint(500, 5000)
        ...
        self.stdout.write(
            self.style.SUCCESS('¡Datos simples poblados exitosamente!')
        )